...
| Need in-depth investigation of a research topic | `academic-deep-research` |
     ...
     ** Only triggered when Decision = Minor/Major Revision **
     ...
     +-> [eic_agent] guides the user through Socratic dialogue:
         ...
         3. Contribution framing probe — ask the Layer-5 later-stage anchored forms
            ...
            academic-deep-research/agents/socratic_mentor_agent.md — read the question text
...
```
academic-deep-research --> academic-paper --> [integrity check] --> academic-paper-reviewer --> academic-paper (revision) --> academic-paper-reviewer (re-review) --> [final integrity] --> finalize
...
| `academic-deep-research` | Upstream (provides research foundation) |
