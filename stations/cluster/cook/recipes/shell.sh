#!/usr/bin/env bash
# ============================================================================
#  CLUSTER: SHELL (dotfiles/shell environment installer)
# ============================================================================
...
# Usage: bake call s=cluster d=shell - safe to re-run any time, every
# step checks before it acts, so a second run never reinstalls tools or
# silently rewrites your dotfiles.
